...
Original file is located at
    https://colab.research.google.com/drive/1fx_36a1F-KMICisj4KnrPqGMO5-W_6MS
...
#printing no of columns and rows
titanic_data.shape

#getting some info about the data
titanic_data.info()

#check the number of missing velues in each coloumn
...
#replacing the missing velues in "Embarked " column with the mode values
